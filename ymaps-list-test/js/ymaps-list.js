    ...
    _createClass(Ylist, [{
        ...
        value: function _checkRequiredOptions() {
            ...
            if (this.options.hasOwnProperty('map') && _typeof(this.options.map) == 'object') {
                ...
                if (!this.options.map.hasOwnProperty('tooltipText')) {
                    this.options.map.tooltipText = 'To drag map touch screen by two fingers and move';
                }
            }
        ...
        value: function _initMap() {
            ...
            if (this.isLessThanAdaptiveBreakpoint && this.options.map.drag.disableBeforeBreakpoint) {
                ...
                var $tooltip = $container.find('.ylist-tooltip');
        ...
        value: function _initMapTooltip() {
            ...
            if (!$container.find('.ylist-tooltip').length) {
                var $tooltip = $('<div class="ylist-tooltip">\n                                  <span class="ylist-tooltip__text">' + this.options.map.tooltipText + '</span>\n                              </div>');
